<form action="{{ route('books.update', $book->id) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="title" id="title" value="{{ $book->title }}"
            aria-describedby="helpId" placeholder="Enter book title">
        @error('title')
        ...
        <div class="col-md">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="isbn" id="isbn" value="{{ $book->isbn }}"
                    aria-describedby="helpId" placeholder="Enter book isbn">
                @error('isbn')
                    <small class="text-danger fw-bold">{{ $message }}</small>
                @enderror
            </div>
        ...
        <div class="col-md">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="author" id="author" value="{{ $book->author }}"
                    aria-describedby="helpId" placeholder="Enter book author">
                @error('author')
                    <small class="text-danger fw-bold">{{ $message }}</small>
                @enderror
            </div>
        ...
        <div class="col-md">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="publisher" id="publisher"
                    value="{{ $book->publisher }}" aria-describedby="helpId" placeholder="Enter book publisher">
                @error('publisher')
                    <small class="text-danger fw-bold">{{ $message }}</small>
                @enderror
            </div>
        ...
        <div class="col-md">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="book_count" id="book_count"
                    value="{{ $book->book_count }}" aria-describedby="helpId" placeholder="Enter book book count">
                @error('book_count')
                    <small class="text-danger fw-bold">{{ $message }}</small>
                @enderror
            </div>
        ...
        <div class="col-md">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="bookshelf" id="bookshelf"
                    value="{{ $book->bookshelf }}" aria-describedby="helpId" placeholder="Enter book bookshelf">
                @error('bookshelf')
                    <small class="text-danger fw-bold">{{ $message }}</small>
                @enderror
            </div>
        ...
        <div class="col-md">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="price" id="price"
                    value="{{ $book->price }}" aria-describedby="helpId" placeholder="Enter book price">
                @error('price')
                    <small class="text-danger fw-bold">{{ $message }}</small>
                @enderror
            </div>
        ...
        <div class="col-md">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="source" id="source"
                    value="{{ $book->source }}" aria-describedby="helpId" placeholder="Enter book source">
                @error('source')
                    <small class="text-danger fw-bold">{{ $message }}</small>
                @enderror
            </div>
